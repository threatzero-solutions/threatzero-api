...
export class AddLocationToTip1711601256329 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tip" ADD CONSTRAINT "FK_87cdf83d8ecf379bacc2cb95bc1" FOREIGN KEY ("locationId") REFERENCES "location"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tip" DROP CONSTRAINT "FK_87cdf83d8ecf379bacc2cb95bc1"`,
    );
    await queryRunner.query(
