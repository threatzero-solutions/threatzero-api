...
export class Initial1710455725260 implements MigrationInterface {
    name = 'Initial1710455725260'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "course" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdOn" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedOn" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "visibility" "public"."course_visibility_enum" NOT NULL DEFAULT 'hidden', "metadataTitle" character varying(100), "metadataDescription" text, CONSTRAINT "PK_bf95180dd756fd204fb01ce4916" PRIMARY KEY ("id"))`);
